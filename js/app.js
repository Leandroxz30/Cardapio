...
var CELULAR_EMPRESA = '5531993361385';
...
cardapio.metodos = {
    ...
    diminuirQuantidade: (id) => {
        ...
        //atualiza o badge total dos botoes "meu carrinho"
        atualizarBadgeTotal: () => {
        ...
        //aumentar quantidade de item no carrinho
            ...
            if (cep != "") {
                ...
                $.getJSON("https://viacep.com.br/ws/" + cep + "/json/?callback=?", function (dados) {
                    ...
                    if (!("erro" in dados)) {
                         ...
                         //atualizar os campos de valores retornados 
        ...
        finalizarPedido: () => {
            ...
            if (MEU_CARRINHO.length > 0 && MEU_ENDERECO != null) {
                ...
                texto += `\n\n*Total (com entrega): R$ ${(VALOR_CARRINHO + VALOR_ENTREGA).toFixed(2).replace('_', ',')}*`;
